...
from arch import conditioned_temporal_mage_arch
from models.mage_temporal_pretrain_model import MageModel
...
def main(args):
    ...
    model = conditioned_temporal_mage_arch.__dict__[args.model.get("type")](**subdict(args.model, 'type'))
