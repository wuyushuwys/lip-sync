...
from models.temporal_vqgan_model import TemporalVQGANModel
...
def main(args):
    ...
    trainer = TemporalVQGANModel(opt=args,
                                 g_model=g_model,
    ...
    # Load state_dict
    trainer.load_model(model=g_model, ckpt_path=args.get("g_weight", None), strict=False)
