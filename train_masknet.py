...
from arch.masknet_arch import MaskNet
from models.masknet_model import MaskNetModel
...
def main(args):
    ...
    model = MaskNet(gt_resolution=args.model.gt_resolution,
                    latent_resolution=args.model.latent_resolution,
                    in_ch=3,
                    nf=args.model.nf,
                    ch_mult=args.model.ch_mult,
                    num_embed=args.model.num_embed)
    ...
    if args.get("weight", None) or args.ckpt:
